...
const AdmissionsListClientAffectation: React.FC = () => {
 ...
 {/* 
                  ...
                  {(form.isConfirmed === false) && (
                   ...
                   {!(form.isConfirmed === true || form.isConfirmed === false) && (
                    ...
                    <td className="py-2 px-4 gap-[2px] text-center border-b border-gray-700 text-[12px]">
                      <p className='flex'> 
                      <Link href={`/admissionformaffectation/${form._id}`}>

                          <button className='bg-green-400 hover:text-black ml-1 p-1 px-[5px] rounded-sm text-gray-900 font-[600]'>Affectation</button>
                      </Link>
                        </p>
                    </td>
...
export default withAuth(AdmissionsListClientAffectation);
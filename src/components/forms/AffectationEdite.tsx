...
import AdmissionListAffectationEdite from '../AdmissionsList/AdmissionListAffectationEdite';
...
interface AffectationDataProps {
  ...
  return (
    ...
    <div className='text-gray-300  text-2xl font-700 justify-center flex'>
     ...
     <AdmissionListAffectationEdite formAffectation={formAffectation} id={id} formAfSelect={formAfSelect}/>
  </div>
  )
}

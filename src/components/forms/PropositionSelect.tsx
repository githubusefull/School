...
interface PropositionDataSelectProps {
    formSelect: FormData;
}


  const PropositionSelect: React.FC<PropositionDataSelectProps> = ({ formSelect }) => {

  return (
     <div className="justify-center mt-2 w-[170vh]">
    <div className='text-gray-300  text-2xl font-700 justify-center flex'>
      <p className='text-red-300 text-[34px]'>Proposition Select</p>
      {formSelect.name}
    </div>
...
export default withAuth(PropositionSelect);